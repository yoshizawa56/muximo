...
const workspaceCases = [
  ...
  },
  {
    ...
    assert: [hasError<EmptyContext, Workspace>({ code: "invalid_entity" })],
  },
  {
    name: "rejects an identity update",
    input: { kind: "reject-id-update" },
    assert: [hasError<EmptyContext, Workspace>({ message: "Workspace update cannot change immutable field: id" })],
  },
...
const paneCases = [
  ...
  },
  {
    ...
    input: { kind: "reject-invalid-current" },
    assert: [hasError<EmptyContext, Pane>({ code: "invalid_entity" })],
  },
  {
    name: "rejects an immutable identity update",
    input: { kind: "reject-immutable-update" },
    assert: [hasError<EmptyContext, Pane>({ message: "Pane update cannot change immutable field: id" })],
  },
  {
    name: "rejects a host pane identity update",
    input: { kind: "reject-host-pane-identity-update" },
    assert: [hasError<EmptyContext, Pane>({ message: "Pane update cannot change immutable field: hostPaneId" })],
  },
  {
    name: "rejects a host server identity update",
    input: { kind: "reject-host-server-identity-update" },
    assert: [hasError<EmptyContext, Pane>({ message: "Pane update cannot change immutable field: hostServerId" })],
  },
  {
    name: "rejects a direct state update",
    input: { kind: "reject-state-update" },
    assert: [hasError<EmptyContext, Pane>({ message: "Pane update cannot change immutable field: state" })],
  },
  {
...
const agentSessionCases = [
  ...
  },
  {
    ...
    input: { kind: "reject-invalid-current" },
    assert: [hasError<EmptyContext, AgentSession>({ code: "invalid_entity" })],
  },
  {
    name: "rejects an identity update",
    input: { kind: "reject-id-update" },
