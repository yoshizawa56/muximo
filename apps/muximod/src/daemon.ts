...
import { formatMuximodHealthFailure } from "./cli/health-diagnostics.js";
import { disposeOwnedOpenCodeServers, refreshOwnedOpenCodeServers } from "./cli/opencode-registry.js";
import { createMuximodServer } from "./server.js";

// Re-exported for the @muximo/muximod/runtime facade and legacy CLI consumers.
export { disposeOwnedOpenCodeServers, formatMuximodHealthFailure, refreshOwnedOpenCodeServers };
