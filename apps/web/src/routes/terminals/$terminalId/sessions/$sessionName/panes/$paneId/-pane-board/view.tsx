...
export function PaneBoardView({
  ...
  return (
    <div className="relative min-h-0">
      {!isOpen ? (
        <aside
          className="flex min-h-[480px] flex-col rounded-[15px] border border-line bg-[rgb(248_248_244_/_82%)] p-[18px] text-[#303631] shadow-[0_18px_42px_rgb(39_46_38_/_6%)] max-[1180px]:p-3.5 max-[920px]:fixed max-[920px]:inset-[64px_12px_12px] max-[920px]:hidden max-[920px]:min-h-0 max-[920px]:bg-paper max-[920px]:shadow-[0_24px_70px_rgb(30_36_31_/_24%)]"
