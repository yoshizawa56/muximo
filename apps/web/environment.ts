...
export type { MuximoEnvironmentName, MuximoEnvironmentProfile } from "@muximo/environment";

export type ResolveWebEnvironmentProfileOptions = {
...
export function resolveWebEnvironmentProfile(options: ResolveWebEnvironmentProfileOptions): MuximoEnvironmentProfile {
