...
function createRuntime(): MuximoCliRuntimeOptions {
  return {
    ...
    webPidFile: "/home/test/.local/state/muximo/web.pid",
    webLogFile: "/home/test/.local/state/muximo/web.log",
    webStartLockDirectory: "/home/test/.local/state/muximo/web.start.lock",
